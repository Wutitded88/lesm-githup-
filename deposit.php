        ...
        <div class="tt_l tt_full">
          ...
          ?>
                ...
                <div class="bank-acc-info" style="margin-bottom: 25px;">
                  <button style="background:linear-gradient(to right, #47007c, #8400c7);" class="btn-copy blobgame bluegame active" onClick="copyToClipboard('#bank_acc_<?=$row['a_bank_code']?>')" ><i class="fa fa-copy"></i> คัดลอกเลขบัญชี</button>
                </div>
                <?php
              }
              ?>
                  ...
                  <div>
                    ...
                    <form name="form">
                      ...
                      <div class="form-group mt-2">
                        <button style="background:linear-gradient(to right, #f58220, #ffd400);" type="submit" id="btn_tmwtopup" onClick="topuptmwvoucher('<?=base_url()?>');return false;" class="tt_l tt_ful fr_submit_bk">
