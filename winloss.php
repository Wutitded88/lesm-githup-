      ...
      <div class="tt_l tt_full tt_content bg">
        <div class="tt_l tt_full">
          ...
          <!-- <img src="images/sd1.gif" style="border-radius:20px; width:100%;"> --> 
            ...
            {
            ?>
            <button type="button" id="btn_winloss" onClick="loadingPage();" class="tt_l tt_ful fr_submit_bk" style="background: linear-gradient(to right, #6900ff, #009aff);box-shadow: 1px 1px 20px rgb(21 123 255);">
            ...
            {
            ?>
            <button type="button" style="background:linear-gradient(to right, #ff0000, #ff2ab4); box-shadow: 1px 1px 20px rgb(255 22 93);" class="tt_l tt_ful fr_submit_bk" disabled>
            ...
            <div class="tt_l tt_full tb_hd" style="margin-top: 40px; margin-bottom: 40px;">
              <table class="tablea" style="width:100%; font-size: 20px; text-align: center;     border-radius: 11px;">
                <tbody class=" ">
                  <tr class="tr-table">
                    <td td="col">
                      วันที่
			...
			<div class="now-turn">
            <a style="color: #caa41b; font-family: thaisanslite_r1; font-size: 18px;"><i class="fad fa-engine-warning"></i> ระบบคืนยอดเสียจะคำนวนหลังเที่ยงคืนทุกวัน</a>
          </div>
          </div>
        </div>
      </div>
